...
def printHelp():
    ...
    -a      wandelt .max/.out Datei einer Maximarechnung aus AMOLQC in ein Python Skript für Blender um
    -o [n]  erstellt aus .orb Dateien aus IboView-Mod Python Skripte für Blender um die Orbitale darzustellen
    """)
